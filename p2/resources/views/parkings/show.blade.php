...
{{-- @section('content')
    ...
    @if ($parkingFound)
        ...
        <nav>
            ...
            <nav>
                <p>
                    Under Construction - Details about the parking will go here...
                </p>
                    ...
                    <div class='myDiv'>
                        <fieldset>
                            ...
                            <input type='text' test='hours' name='hours' value=0 id='hours'><label for='hours'>
                                ...
                                <input type='radio' test='student-option' name='selection' value='Student'
                                ...
                                <input type='radio' test='faculty-option' name='selection' value='Faculty'
                                    id='faculty'><label for='faculty'>Faculty</label>
                                <input type='radio' test='visitor-option' name='selection' value='Vistor'
                                    id='visitor'><label for='visitor'>Visitor</label>
